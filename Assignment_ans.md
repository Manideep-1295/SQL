...
UPDATE Orders 
SET  Orders.TotalAmount = Result.new 
FROM Orders
INNER JOIN (
	...
	group by od.OrderID) AS Result 
    ON Orders.OrderID = test.OrderID 
...
SELECT ProductName,SUM(p.Price * od.Quantity) AS total 
FROM Orders o
